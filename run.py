...
def run():
    ...
    parser.add_argument('--num_recurrences', type=int, default=6)
    ...
    model = RFRNetModel()
    if args.test:
        model.initialize_model(args.model_path, False, args.num_recurrences)
        model.cuda()
        ...
        model.initialize_model(args.model_path, True, args.num_recurrences)
        model.cuda()
